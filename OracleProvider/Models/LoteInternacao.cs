    ...
    public class LoteInternacao
    {
        ...
        public class Internacao
        {
            public Internacao()
            {
                ...
                this.Ctis = new List<Cti>();

                this.Rns = new List<Rn>();

                this.CondicoesAdquirida = new List<CondicaoAdquirida>();

                this.AltasAdministrativa = new List<AltaAdministrativa>();

                this.AnalisesCritica = new List<AnaliseCritica>();

                this.SuporteVentilatorios = new List<SuporteVentilatorio>();
            }
            ...
            [XmlIgnore]
            public string CdTipoInternacao { get; set; }
            ...
            [XmlIgnore]
            public string CdMotAlt { get; set; }
            ...
            public List<Cti> Ctis { get; set; }

            [XmlElement(ElementName = "Rn")]
            public List<Rn> Rns { get; set; }

            [XmlElement(ElementName = "CondicaoAdquirida")]
            public List<CondicaoAdquirida> CondicoesAdquirida { get; set; }

            [XmlElement(ElementName = "AltaAdministrativa")]
            public List<AltaAdministrativa> AltasAdministrativa { get; set; }

            [XmlElement(ElementName = "AnaliseCritica")]
            public List<AnaliseCritica> AnalisesCritica { get; set; }

            [XmlElement(ElementName = "SuporteVentilatorio")]
            public List<SuporteVentilatorio> SuporteVentilatorios { get; set; }
        ...
        public class Medico
        {
            ...
            [XmlElement(ElementName = "especialidade")]
